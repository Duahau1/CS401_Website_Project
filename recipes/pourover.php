...
<body>
<div>
    <h1>PourOver Coffee</h1>    
    <img src="../img/recipespourover.jpg" class="figure">
    ...
    <li>Step two:Wet the paper filter with just enough hot water to saturate it. This reduces any potential for a "paper taste" in your coffee. Then pour the excess water out through the spout.</li>
    <li>Step three:Add just enough water to cover the coffee grounds (~66ml) so the coffee can "bloom." Then wait 45 seconds. This is a step that lets gas escape from the coffee to help improve the overall flavor.</li>
